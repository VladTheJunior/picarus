...
## Описание
Интерактивный просмотрщик предметов для Riders of Icarus - это десктопное приложение, которое позволяет игрокам просматривать и искать игровые предметы, читая файлы клиента непосредственно на компьютере пользователя. Просмотрщик обеспечивает быстрый доступ к данным предметов с фильтрацией и интерактивными симуляционными функциями.
